...
(define (dispatch-init client-run-fp tile-did-change-fp tile-did-move-fp tile-was-deleted-fp interp-stdin-fd interp-stdout-fd)
  ...
  (set! init-completion
   (thread
    (λ ()
      (callbacks-init tile-did-change-fp tile-did-move-fp tile-was-deleted-fp)
